...
export default function ServiceDetailsPage() {
  ...
  return (
    <div className="bg-primary">
      {/* Hero Section */}
      <div className="relative pt-40 pb-24 min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          >
            <div className="w-16 h-16 md:w-20 md:h-20 bg-accent/20 backdrop-blur-md rounded-2xl flex items-center justify-center mx-auto mb-8 border border-accent/30 shadow-xl">
              <Icon className="w-8 h-8 md:w-10 md:h-10 text-accent" />
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 tracking-tight font-serif">
              {service.title}
            </h1>
