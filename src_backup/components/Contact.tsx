        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    id="name"
                    className="w-full bg-primary border border-glass-border-hover rounded-xl px-4 py-3 text-text-primary focus:outline-none focus:border-accent/50 focus:ring-1 focus:ring-accent/50 transition-all"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-text-muted mb-2">Project Details</label>
                <textarea
                  id="message"
                  rows={4}
                  className="w-full bg-primary border border-glass-border-hover rounded-xl px-4 py-3 text-text-primary focus:outline-none focus:border-accent/50 focus:ring-1 focus:ring-accent/50 transition-all resize-none"
              ...
              <button
                type="submit"
                className="w-full py-4 bg-accent text-primary font-bold rounded-xl hover:bg-accent-hover transition-colors flex items-center justify-center group"
              >
                Send Message
