      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 text-center mt-20">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-text-primary leading-tight mb-6">
            ...
            <span className="text-accent italic font-serif">Elegant Interior Design</span>
          </h1>
          <p className="text-base md:text-lg text-text-muted mb-10 max-w-2xl mx-auto font-light leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/contact"
              className="w-full sm:w-auto px-8 py-4 bg-accent text-primary font-semibold rounded-full hover:bg-accent-hover transition-all flex items-center justify-center group"
            >
