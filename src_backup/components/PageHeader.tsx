  ...
  return (
    <section className="relative pt-40 pb-24 flex items-center justify-center overflow-hidden min-h-[50vh]">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-12 text-center">
        ...
        >
          <h1 className="text-3xl md:text-5xl font-bold text-text-primary mb-6">{title}</h1>
          <p className="text-base text-text-muted max-w-2xl mx-auto font-light leading-relaxed">
            {description}
          </p>
        </motion.div>
      </div>
